        ...
        class DATA_EXPORT AABB 
        {
            public:
                ...
                ****************************************************************************************/
                virtual ~AABB();
            public:
                Math::Vector2<float> m_origin;      /**< This is the starting point of the AABB */
                int m_width;                        /**< This is the width of the AABB */
                int m_height;                       /**< This is the height of the AABB */
        };
    }
}
#endif
