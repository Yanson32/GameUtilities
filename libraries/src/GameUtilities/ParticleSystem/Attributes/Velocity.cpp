...
*   @Date       04/06/19
*   @class      This class creates a velocity attribute.   
*   @file       Velocity.cpp
**************************************************************************/
...
namespace GU
{
	namespace PS
	{
		namespace AT
		{
            ...
            ****************************************************************************/
			Velocity::Velocity(GU::PS::AT::AttributeManager &manager, const std::size_t &size):
            AttributeBase::AttributeBase(manager, GU::PS::AT::Id::VELOCITY),
            m_data(size)
			{
